...
yt-dlp-cli is a feature-rich command-line audio/video downloader with support for [thousands of sites](supportedsites.md). The project is a fork of [youtube-dl](https://github.com/yt-dlp/yt-dlp) based on [youtube-dl](https://github.com/ytdl-org/youtube-dl).
